    ...
    <div className="min-h-screen bg-background flex flex-col items-center justify-center p-4 relative overflow-hidden text-foreground">
      ...
      <Card className="w-full max-w-lg z-10 bg-card border-border shadow-2xl relative overflow-hidden">
        ...
        <CardHeader className="space-y-1 text-center pt-8">
          <CardTitle className="text-2xl font-bold tracking-tight text-foreground">Cadastro de Lojista</CardTitle>
          <CardDescription className="text-muted-foreground">Preencha os dados para iniciar o período de avaliação.</CardDescription>
        </CardHeader>
          ...
          <CardContent className="space-y-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="space-y-2">
                <label className="text-xs font-mono text-muted-foreground uppercase">Seu Nome</label>
              ...
              <div className="space-y-2">
                <label className="text-xs font-mono text-muted-foreground uppercase">Nome da Empresa</label>
                <div className="relative">
            ...
            <div className="space-y-2">
              <label className="text-xs font-mono text-muted-foreground uppercase">CNPJ ou CPF</label>
              <div className="relative">
                <Input 
                  id="document" 
                  type="text" 
                  placeholder="00.000.000/0001-00" 
                  className="px-3 h-11 bg-background border-border focus:border-purple-500 focus:ring-purple-500/25 transition-all text-foreground placeholder:text-muted-foreground"
                  value={document}
            ...
            <div className="space-y-2">
              <label className="text-xs font-mono text-muted-foreground uppercase">Senha</label>
              <div className="relative">
            ...
            <div className="flex items-center gap-2 pt-2 border-t border-border mt-2">
              ...
              <label htmlFor="terms" className="text-xs text-muted-foreground select-none">
                Estou de acordo com os <a href="/termos-de-uso" target="_blank" className="text-purple-500 hover:underline">Termos de Uso</a> e <a href="/politica-privacidade" target="_blank" className="text-purple-500 hover:underline">Política de Privacidade</a>.
              </label>
            </div>
          </CardContent>
